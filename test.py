...
if __name__ == "__main__":
    ...
    if envType == 0:
        ...
        calculate_pf = __import__(f'team{team_number}.interaction_chainMDP', fromlist=['calculate_performance']).calculate_sample_efficiency
        ...
        calculate_pf = __import__(f'team{team_number}.interaction_lava', fromlist=['calculate_performance']).calculate_sample_efficiency
